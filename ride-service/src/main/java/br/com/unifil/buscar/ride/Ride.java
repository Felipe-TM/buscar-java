...
public class Ride {
    ...
    public Ride() {
	this.enrolledPassengers = new LinkedList<>();
    }
    ...
    @BsonIgnore
    public RideRecord getAsRecord() {
	return new RideRecord(destination, origin, alternatives, arrivalTime, avoid, departureTime, language, mode,
		region, trafficModel, transitMode, transitRoutingPreference, DEFAULT_UNITS, waypoints, rideStatus,
		driverId, enrolledPassengers, rideId);
    }
